...
class ECG:
	def  getImage(self,image):
		...
		return: user image
		"""
		image = "C:/Users/Shree/Desktop/programming/flask/semicolons-24/models/ecg/M1.jpg"
		image = imread(image)
	...
	def DimensionalReduciton(self,test_final):
		...
		pca_loaded_model = joblib.load('C:/Users/Shree/Desktop/programming/flask/semicolons-24/models/ecg/PCA_ECG.pkl')
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		loaded_model = joblib.load('C:/Users/Shree/Desktop/programming/flask/semicolons-24/models/ecg/Heart_Disease_Prediction_using_ECG.pkl')
